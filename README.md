...
TJ(Tribunal de Justiça do Estado do Rio Grande do Norte) as a tech lead and developer(Java, javascript)
Via(Marketplace company) as a Java backend developer(Java, javascript, Go)
